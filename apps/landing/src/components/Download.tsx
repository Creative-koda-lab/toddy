              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Version 0.1.0 • {primaryPlatform.fileSize} • Universal
                  </p>

                  <div className="flex flex-col sm:flex-row gap-3">
                    <a
                      href={primaryPlatform.downloadUrl}
                      className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors shadow-lg shadow-primary/25"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {platforms.map((platform, index) => (
              <a
                ...
                className="group relative p-6 rounded-xl border border-border bg-card hover:bg-accent/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              >
                <div className="flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{platform.fileSize}</p>
                  </div>
                </div>
              </a>
            ))}
