export default function Footer() {
  ...
  const links = {
    product: [
      ...
      { name: 'Releases', href: 'https://github.com/taissirtigzirt/toddy/releases' },
      { name: 'Changelog', href: 'https://github.com/taissirtigzirt/toddy/releases' }
    ],
    community: [
      { name: 'GitHub', href: 'https://github.com/taissirtigzirt/toddy' },
      { name: 'Issues', href: 'https://github.com/taissirtigzirt/toddy/issues' },
      { name: 'Discussions', href: 'https://github.com/taissirtigzirt/toddy/discussions' },
      { name: 'Contributing', href: 'https://github.com/taissirtigzirt/toddy/blob/main/CONTRIBUTING.md' }
    ],
    legal: [
      { name: 'License (MIT)', href: 'https://github.com/taissirtigzirt/toddy/blob/main/LICENSE' },
      { name: 'Privacy', href: '#privacy' },
      { name: 'Security', href: 'https://github.com/taissirtigzirt/toddy/security' }
    ]
  };
