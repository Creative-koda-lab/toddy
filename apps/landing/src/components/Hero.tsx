      ...
      <div className="container mx-auto px-6 py-24 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
            A privacy-first desktop application that keeps all your data securely stored on your own computer.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <a
              href="#download"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors shadow-lg shadow-primary/25"
            >
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="relative rounded-xl border border-border bg-card shadow-2xl overflow-hidden">
              ...
              <div className="aspect-video bg-gradient-to-br from-muted/30 to-muted/10 flex items-center justify-center p-12">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">Your data stays private and secure</p>
                </div>
              </div>
            </div>
          </div>
